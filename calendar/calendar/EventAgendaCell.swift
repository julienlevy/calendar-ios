...
class EventAgendaCell: UITableViewCell {
    ...
    func setupConstraints() {
        ...
        let topMember: NSLayoutConstraint = NSLayoutConstraint(item: self.durationLabel, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: self.titleLabel, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: 2)
        let leftMember: NSLayoutConstraint = NSLayoutConstraint(item: self.durationLabel, attribute: NSLayoutAttribute.Left, relatedBy: NSLayoutRelation.Equal, toItem: self.titleLabel, attribute: NSLayoutAttribute.Left, multiplier: 1, constant: 0)
        
        self.locationView.translatesAutoresizingMaskIntoConstraints = false
        let topLocation: NSLayoutConstraint = NSLayoutConstraint(item: self.durationLabel, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: self.memberView, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: 2)
        let leftLocation: NSLayoutConstraint = NSLayoutConstraint(item: self.durationLabel, attribute: NSLayoutAttribute.Left, relatedBy: NSLayoutRelation.Equal, toItem: self.titleLabel, attribute: NSLayoutAttribute.Left, multiplier: 1, constant: 0)
        
        //Setting bottom as equal to max of 2 views that can be at bottom
        let bottomDuration: NSLayoutConstraint = NSLayoutConstraint(item: self.durationLabel, attribute: NSLayoutAttribute.Bottom, relatedBy: NSLayoutRelation.GreaterThanOrEqual, toItem: self, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: -rowVerticalInset)
        let bottomLocation: NSLayoutConstraint = NSLayoutConstraint(item: self.durationLabel, attribute: NSLayoutAttribute.Bottom, relatedBy: NSLayoutRelation.GreaterThanOrEqual, toItem: self, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: -rowVerticalInset)

...
func demoEvents() -> [Event] {
    ...
    let firstEvent: Event = Event(eventTitle: "Techcrunch Interview", eventDate: NSDate(), eventDuration: 140, eventContainingCalendar: kPersonalCalendar, eventMembers: [julienLevy])

    let beforeEvent: Event = Event(eventTitle: "Coffee John", eventDate: firstEvent.date.dateByAddingTimeInterval(-secondsInHours/2), eventDuration: 140, eventContainingCalendar: kPersonalCalendar)
